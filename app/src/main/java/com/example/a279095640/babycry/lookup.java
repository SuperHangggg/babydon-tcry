...
public class lookup extends AppCompatActivity {
    ...
    private Handler handler = new Handler(){
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case SUCCESS:
                    Toast.makeText(lookup.this,(String)msg.obj, Toast.LENGTH_SHORT).show();

                    break;

                case ERROR:
                    Toast.makeText(lookup.this,"查询失败请重试", Toast.LENGTH_SHORT).show();
                    break;
        ...
        new Thread(){
            public void run(){
                try {
                    ...
                    //区别1、url的路径不同
                    String path = "http://192.168.1.113:8080/lookup.php";
